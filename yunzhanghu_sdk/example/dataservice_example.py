...
if __name__ == '__main__':
    ...
    resp = DataserviceClient.get_daily_order_file(req)
    ...
    resp = DataserviceClient.get_daily_bill_file_v2(req)
    ...
    resp = DataserviceClient.list_dealer_recharge_record_v2(req)
    ...
    resp = DataserviceClient.list_daily_order(req)
    ...
    resp = DataserviceClient.get_daily_order_file_v2(req)
    ...
    resp = DataserviceClient.list_daily_bill(req)
    ...
    resp = DataserviceClient.list_balance_daily_statement(req)
