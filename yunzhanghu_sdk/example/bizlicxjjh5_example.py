...
if __name__ == "__main__":
    bizlic_xjj_h5_client = BizlicXjjH5ServiceClient(config=init_config())
    ...
    resp = bizlic_xjj_h5_client.h5_get_start_url(req)
    ...
    resp = bizlic_xjj_h5_client.h5_eco_city_aic_status(req)
