...
class ApiusersignClient(BaseClient):
    ...
    def api_use_sign_contract(self, request: ApiUseSignContractRequest):
        ...
        """
        return self._get("/api/sign/v1/user/contract", request.request_id, Utils.copy_dict(request.__dict__))
    ...
    def api_user_sign(self, request: ApiUserSignRequest):
        ...
        """
        return self._post("/api/sign/v1/user/sign", request.request_id, Utils.copy_dict(request.__dict__))
    ...
    def get_api_user_sign_status(self, request: GetApiUserSignStatusRequest):
        ...
        """
        return self._get("/api/sign/v1/user/status", request.request_id, Utils.copy_dict(request.__dict__))
    ...
    def api_user_sign_release(self, request: ApiUserSignReleaseRequest):
        ...
        """
        return self._post("/api/sign/v1/user/release", request.request_id, Utils.copy_dict(request.__dict__))
